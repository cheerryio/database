...
function Login(props) {
    ...
    return (
        <div className=" w-screen h-screen pt-1/5 text-red-800 bg-indigo-100 sm:pt-1/10  ">
            <div className="relative">
                <div className='flex flex-row justify-center items-center bg-gradient-to-b from-indigo-100 to-indigo-200 '>
                    <div className=" font-bold text-6xl text-center mb-2">天天航空</div>
                </div>
                <div className="relative  w-full h-28 pt-3 text-center text-green-500 text-3xl -z-50  bg-indigo-200 shadow-sm" style={{ borderRadius: '0 0 50% 50%', textShadow: '0 0 8px #747acc' }}>竭诚服务，平安出行</div>
            </div>
